...
assert.ok(production.includes('card-runtime-core-builder-v1.3.6.js?v=1.3.6-m3.8'));
assert.ok(production.includes('card-runtime-renderer-v1.3.6.js?v=1.3.6-m3.7'));
